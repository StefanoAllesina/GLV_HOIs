...
# plot them together
show(plot_output(outpairs$out, outhois$out) + geom_point(data = tibble(time = 0, abundance = p$xstar, variable = as.factor(1:4), model = "second")))
```
...
outhois <- integrate_dynamics(p, model = "glv_hois", maxtime = 200)
# plot them together
show(plot_output(outpairs$out, outhois$out) + geom_point(data = tibble(time = 0, abundance = p$xstar, variable = as.factor(1:4), model = "first")))
```
...
# plot them together
show(plot_output(outhois$out,outpairs$out))
```
